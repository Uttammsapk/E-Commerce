...
// sql query to select the data from data base
$cat_res=mysqli_query($con,"select * from categories where status=1 order by categories asc limit 3");

// array variable to store the values from above query
$cat_arr=array();
...
// fetching data for dynamic update in wishlist icon
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="./img/headlogo.png" alt="logo images"></a>
                                </div>
                            </div>
                            <div class="col-md-7 col-lg-6 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
										...
										<!-- php code for getting dynamic categories value in top bar from  -->
                                        <?php
